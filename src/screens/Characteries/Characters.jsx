...
import hasanhekal from "../../assets/images/hasanhekal.webp";
import Mmansour from "../../assets/images/M.mansour.webp";
import yassen from "../../assets/images/yassen.mansour.webp";
...
const MansDATA = [
  { logo: Nageb, title: "نجيب ساويرس", description: "رجل أعمال ومستثمر" },
  { logo: hasanhekal, title: "حسن هيكل", description: "رئيس مجلس إدارة سابق لمجموعة هيرميس المالية" },
  { logo: Mmansour, title: "محمد منصور", description: "رئيس مجموعة منصور" },
  { logo: yassen, title: "ياسين منصور", description: "رجل أعمال ومستثمر" },
  { logo: Nageb, title: "نجيب ساويرس", description: "رجل أعمال ومستثمر" },
  { logo: hasanhekal, title: "حسن هيكل", description: "رئيس مجلس إدارة سابق لمجموعة هيرميس المالية" },
  { logo: Mmansour, title: "محمد منصور", description: "رئيس مجموعة منصور" },
  { logo: yassen, title: "ياسين منصور", description: "رجل أعمال ومستثمر" },
        ...
        <section className="container flex flex-col py-6">
          <div className="flex flex-col lg:flex-row">
            <main className="flex flex-col flex-1 w-full gap-6 lg:gap-8 md:pe-3 lg:w-2/3">
              <Breadcrumb />
              <MainTitle title="شخصيات هامة" noMore={true} />
