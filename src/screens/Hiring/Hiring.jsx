...
const fields = [
  ...
  { name: "degree", type: "text", placeholder: "المؤهل الدراسي" },
  { name: "graduationYear", type: "text", placeholder: "سنة التخرج" },
  { name: "languages", type: "text", placeholder: "اللغات التي تتقنها" },
  { name: "address", type: "text", placeholder: "العنوان الحالي" },
  { name: "jobTitle", type: "text", placeholder: "اسم الوظيفة" },
    ...
    <div className="bg-custom">
      ...
      <section className="container flex flex-col py-6 ">
        <div className="flex flex-col flex-1 w-full gap-6 lg:gap-2 md:pe-3">
          <MainTitle title="   التقديم على وظيفة" noMore={true} />
          <DynamicForm
            fields={fields}
